...
class Departure(models.Model):
    ...
    second_crew_member_id = models.ForeignKey('CrewMember',on_delete=models.SET_NULL, null=True, related_name='crew2')
...
class Transaction(models.Model):
    ...
    ticket_id = models.ForeignKey('Ticket',on_delete=models.SET_NULL, null=True, related_name='ticket_transaction')
    id_client = models.ForeignKey('Client',on_delete=models.SET_NULL, null=True, related_name='client_transaction')
    # méthode
    def get_absolute_url(self):
        """Returns the url to access a particular author instance."""
